...
- Upgrade `clustertest` from v3 to v4.0.0 and `cluster-standup-teardown` from v4 to v5.0.0 for CAPI v1beta2 support.
...
- Fix App name when installing with bundle
...
- Extend nancy ignore rules

## [2.2.0] - 2025-12-19

### Added

- Add configurable bundle override types for setting child app values within bundles.
- Add option to install Apps on the MC with inCluster option.
- Support overriding App install name for bundles.
...
[Unreleased]: https://github.com/giantswarm/apptest-framework/compare/v5.3.0...HEAD
[5.3.0]: https://github.com/giantswarm/apptest-framework/compare/v5.2.6...v5.3.0
[5.2.6]: https://github.com/giantswarm/apptest-framework/compare/v5.2.5...v5.2.6
...
[4.1.0]: https://github.com/giantswarm/apptest-framework/compare/v4.0.0...v4.1.0
[4.0.0]: https://github.com/giantswarm/apptest-framework/compare/v3.3.0...v4.0.0
[3.3.0]: https://github.com/giantswarm/apptest-framework/compare/v3.2.0...v3.3.0
...
[2.1.2]: https://github.com/giantswarm/apptest-framework/compare/v2.1.1...v2.1.2
[2.1.1]: https://github.com/giantswarm/apptest-framework/compare/v2.1.0...v2.1.1
[2.1.0]: https://github.com/giantswarm/apptest-framework/compare/v2.0.2...v2.1.0
[2.0.2]: https://github.com/giantswarm/apptest-framework/compare/v2.0.1...v2.0.2
